...
// An error indicating that an updatable timer execution failed to start. Returned when there is an existing timer with
// the given timer ID, and the conflict policy does not permit starting a new one.
type UpdatableTimerExecutionAlreadyStartedFailure struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	StartRequestId string                 `protobuf:"bytes,1,opt,name=start_request_id,json=startRequestId,proto3" json:"start_request_id,omitempty"`
	RunId          string                 `protobuf:"bytes,2,opt,name=run_id,json=runId,proto3" json:"run_id,omitempty"`
	unknownFields  protoimpl.UnknownFields
...
func (x *UpdatableTimerExecutionAlreadyStartedFailure) Reset() {
	*x = UpdatableTimerExecutionAlreadyStartedFailure{}
	mi := &file_temporal_api_errordetails_v1_message_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *UpdatableTimerExecutionAlreadyStartedFailure) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdatableTimerExecutionAlreadyStartedFailure) ProtoMessage() {}

func (x *UpdatableTimerExecutionAlreadyStartedFailure) ProtoReflect() protoreflect.Message {
	mi := &file_temporal_api_errordetails_v1_message_proto_msgTypes[18]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpdatableTimerExecutionAlreadyStartedFailure.ProtoReflect.Descriptor instead.
func (*UpdatableTimerExecutionAlreadyStartedFailure) Descriptor() ([]byte, []int) {
	return file_temporal_api_errordetails_v1_message_proto_rawDescGZIP(), []int{18}
}

func (x *UpdatableTimerExecutionAlreadyStartedFailure) GetStartRequestId() string {
	if x != nil {
		return x.StartRequestId
	}
	return ""
...
func (x *UpdatableTimerExecutionAlreadyStartedFailure) GetRunId() string {
	if x != nil {
		return x.RunId
	}
	return ""
...
const file_temporal_api_errordetails_v1_message_proto_rawDesc = "" +
	...
	",UpdatableTimerExecutionAlreadyStartedFailure\x12(\n" +
	"\x10start_request_id\x18\x01 \x01(\tR\x0estartRequestId\x12\x15\n" +
...
var file_temporal_api_errordetails_v1_message_proto_goTypes = []any{
	...
	(*UpdatableTimerExecutionAlreadyStartedFailure)(nil),   // 18: temporal.api.errordetails.v1.UpdatableTimerExecutionAlreadyStartedFailure
