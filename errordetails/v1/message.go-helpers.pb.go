...
// Marshal an object of type UpdatableTimerExecutionAlreadyStartedFailure to the protobuf v3 wire format
func (val *UpdatableTimerExecutionAlreadyStartedFailure) Marshal() ([]byte, error) {
	return proto.Marshal(val)
}

// Unmarshal an object of type UpdatableTimerExecutionAlreadyStartedFailure from the protobuf v3 wire format
func (val *UpdatableTimerExecutionAlreadyStartedFailure) Unmarshal(buf []byte) error {
	return proto.Unmarshal(buf, val)
}

// Size returns the size of the object, in bytes, once serialized
func (val *UpdatableTimerExecutionAlreadyStartedFailure) Size() int {
	return proto.Size(val)
}

// Equal returns whether two UpdatableTimerExecutionAlreadyStartedFailure values are equivalent by recursively
// comparing the message's fields.
// For more information see the documentation for
// https://pkg.go.dev/google.golang.org/protobuf/proto#Equal
func (this *UpdatableTimerExecutionAlreadyStartedFailure) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	var that1 *UpdatableTimerExecutionAlreadyStartedFailure
	switch t := that.(type) {
	case *UpdatableTimerExecutionAlreadyStartedFailure:
		that1 = t
	case UpdatableTimerExecutionAlreadyStartedFailure:
		that1 = &t
	default:
