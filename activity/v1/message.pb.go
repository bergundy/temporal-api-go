...
type ActivityExecutionInfo struct {
	...
	LastDeploymentVersion *v14.WorkerDeploymentVersion `protobuf:"bytes,20,opt,name=last_deployment_version,json=lastDeploymentVersion,proto3" json:"last_deployment_version,omitempty"`
	// Priority metadata.
	Priority  *v11.Priority                    `protobuf:"bytes,21,opt,name=priority,proto3" json:"priority,omitempty"`
	PauseInfo *ActivityExecutionInfo_PauseInfo `protobuf:"bytes,22,opt,name=pause_info,json=pauseInfo,proto3" json:"pause_info,omitempty"`
	// Current activity options. May be different from the one used to start the activity.
	ActivityOptions *ActivityOptions `protobuf:"bytes,23,opt,name=activity_options,json=activityOptions,proto3" json:"activity_options,omitempty"`
	// Serialized activity input, passed as arguments to the activity function.
	Input *v11.Payloads `protobuf:"bytes,24,opt,name=input,proto3" json:"input,omitempty"`
	// Incremented each time the activity's state is mutated in persistence.
	StateTransitionCount int64                 `protobuf:"varint,25,opt,name=state_transition_count,json=stateTransitionCount,proto3" json:"state_transition_count,omitempty"`
	SearchAttributes     *v11.SearchAttributes `protobuf:"bytes,26,opt,name=search_attributes,json=searchAttributes,proto3" json:"search_attributes,omitempty"`
	Header               *v11.Header           `protobuf:"bytes,27,opt,name=header,proto3" json:"header,omitempty"`
	...
	EagerExecutionRequested bool `protobuf:"varint,28,opt,name=eager_execution_requested,json=eagerExecutionRequested,proto3" json:"eager_execution_requested,omitempty"`
	// Callbacks to be called by the server when this activity reaches a terminal status.
	// Callback addresses must be whitelisted in the server's dynamic configuration.
	CompletionCallbacks []*v11.Callback `protobuf:"bytes,29,rep,name=completion_callbacks,json=completionCallbacks,proto3" json:"completion_callbacks,omitempty"`
	...
	Links []*v11.Link `protobuf:"bytes,31,rep,name=links,proto3" json:"links,omitempty"`
...
func (x *ActivityExecutionInfo) GetPaused() bool {
	if x != nil {
		return x.Paused
	}
	return false
...
type ActivityListInfo struct {
	...
	Memo *v11.Memo `protobuf:"bytes,6,opt,name=memo,proto3" json:"memo,omitempty"`
	// Search attributes from the start request.
	SearchAttributes *v11.SearchAttributes `protobuf:"bytes,7,opt,name=search_attributes,json=searchAttributes,proto3" json:"search_attributes,omitempty"`
...
func (x *ActivityListInfo) GetMemo() *v11.Memo {
	if x != nil {
		return x.Memo
	}
	return nil
...
const file_temporal_api_activity_v1_message_proto_rawDesc = "" +
	...
	"\fretry_policy\x18\x06 \x01(\v2#.temporal.api.common.v1.RetryPolicyR\vretryPolicy\"\x90\x12\n" +
	...
	"\x06paused\x18\x13 \x01(\bR\x06paused\x12k\n" +
	"\x17last_deployment_version\x18\x14 \x01(\v23.temporal.api.deployment.v1.WorkerDeploymentVersionR\x15lastDeploymentVersion\x12<\n" +
	"\bpriority\x18\x15 \x01(\v2 .temporal.api.common.v1.PriorityR\bpriority\x12X\n" +
	"\n" +
	"pause_info\x18\x16 \x01(\v29.temporal.api.activity.v1.ActivityExecutionInfo.PauseInfoR\tpauseInfo\x12T\n" +
	"\x10activity_options\x18\x17 \x01(\v2).temporal.api.activity.v1.ActivityOptionsR\x0factivityOptions\x126\n" +
	"\x05input\x18\x18 \x01(\v2 .temporal.api.common.v1.PayloadsR\x05input\x124\n" +
	"\x16state_transition_count\x18\x19 \x01(\x03R\x14stateTransitionCount\x12U\n" +
	"\x11search_attributes\x18\x1a \x01(\v2(.temporal.api.common.v1.SearchAttributesR\x10searchAttributes\x126\n" +
	"\x06header\x18\x1b \x01(\v2\x1e.temporal.api.common.v1.HeaderR\x06header\x12:\n" +
	"\x19eager_execution_requested\x18\x1c \x01(\bR\x17eagerExecutionRequested\x12S\n" +
	"\x14completion_callbacks\x18\x1d \x03(\v2 .temporal.api.common.v1.CallbackR\x13completionCallbacks\x12F\n" +
	"\ruser_metadata\x18\x1e \x01(\v2!.temporal.api.sdk.v1.UserMetadataR\fuserMetadata\x122\n" +
	"\x05links\x18\x1f \x03(\v2\x1c.temporal.api.common.v1.LinkR\x05links\x12'\n" +
	"\x0fcanceled_reason\x18  \x01(\tR\x0ecanceledReason\x1a\xed\x01\n" +
	"\tPauseInfo\x129\n" +
	"\n" +
	...
	"\x06status\x18\x05 \x01(\x0e2..temporal.api.enums.v1.ActivityExecutionStatusR\x06status\x120\n" +
	"\x04memo\x18\x06 \x01(\v2\x1c.temporal.api.common.v1.MemoR\x04memo\x12U\n" +
...
var file_temporal_api_activity_v1_message_proto_goTypes = []any{
	...
	(*v11.Memo)(nil),                               // 23: temporal.api.common.v1.Memo
}
var file_temporal_api_activity_v1_message_proto_depIdxs = []int32{
	...
	23, // 34: temporal.api.activity.v1.ActivityListInfo.memo:type_name -> temporal.api.common.v1.Memo
	18, // 35: temporal.api.activity.v1.ActivityListInfo.search_attributes:type_name -> temporal.api.common.v1.SearchAttributes
	8,  // 36: temporal.api.activity.v1.ActivityListInfo.execution_duration:type_name -> google.protobuf.Duration
	14, // 37: temporal.api.activity.v1.ActivityExecutionInfo.PauseInfo.pause_time:type_name -> google.protobuf.Timestamp
	6,  // 38: temporal.api.activity.v1.ActivityExecutionInfo.PauseInfo.manual:type_name -> temporal.api.activity.v1.ActivityExecutionInfo.PauseInfo.Manual
